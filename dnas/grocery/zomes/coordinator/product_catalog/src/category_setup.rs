...
pub fn create_category_structure(categories: Vec<CategorySetup>) -> ExternResult<()> {
    for category in categories {
        ...
        category_path
            .typed(LinkTypes::ProductsByCategory)?
            .ensure()?;
        let _products_path =
            Path::try_from(format!("categories/{}/products", category.main_category))?;
        _products_path
            .typed(LinkTypes::ProductsByCategory)?
            .ensure()?;
        ...
        for subcategory in category.subcategories {
            ...
            subcategory_path
                .typed(LinkTypes::CategoryToSubcategory)?
                .ensure()?;
            ...
            for product_type in subcategory.product_types {
                ...
                product_type_path
                    .typed(LinkTypes::ProductTypeToProducts)?
                    .ensure()?;
